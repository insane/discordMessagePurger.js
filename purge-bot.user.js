// ==UserScript==
// @name         Purge Bot
// @namespace    purgebot.local
// @version      5.0.0
// @description  Bulk-delete your own messages in a Discord channel from inside the real web client (no selfbot logouts). Trash button opens a Discord-styled modal with filters, order, smart pacing, progress and dry run.
// @author       github.com/insane
